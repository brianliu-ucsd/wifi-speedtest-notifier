...
Runs an Ookla speed test and shows a macOS notification with the results
automatically whenever you join a new Wi-Fi network or sign back into your
computer.

## What it looks like

> **Speedtest: WIFI_NAME** 
> Down: 677 Mbps  Up: 40 Mbps  Ping: 13 ms

(Shows the gateway's IP address instead of the network name, e.g. "Speedtest:
192.168.50.1", until you complete the optional step below.)
...
1. Clone this repo and `cd` into it:
   ...
   ```sh
   git clone https://github.com/<owner>/wifi-speedtest-notifier.git
...
name, so notifications show the gateway's IP address instead. To get the
real name shown instead:
